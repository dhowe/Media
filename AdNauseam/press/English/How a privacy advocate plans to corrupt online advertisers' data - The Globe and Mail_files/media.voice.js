...
util.loadScript("http://plugin.mediavoice.com/plugin.js", true, "nativeads-plugin");
...
TGAMD.mdvoice = (function ( window ) {
 ...
 function init( cfg ){
     ...
     ads.insertPreview({
       ...
       onError: function(error) {
         ...
         if(defaults.mobile){
           ...
           $('.nativead_earlug + .view_pic,.nativead_block + .view_pic,.nativead_video + .view_videos').show();
    ...
    * elg = earlug native template for a section page
    * Each native template above has a mobi version as well (ex. blkmobi )
   ...
   function chooseTemplate(template) {
     var html = {
       ...
       'elg':function (Handlebars,depth0,helpers,partials,data) {
          ...
          buffer += "<div class=\"widget_stories view_pic nativead_earlug\"><article class=\"art--nativecontent-earlug img_left img_w140 last_image clearfix\" data-vr-contentbox=\"\">\n <a href=\"";
          if (stack1 = helpers.link) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
          else { stack1 = depth0.link; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
          buffer += escapeExpression(stack1)
          + "\" class=\"o-ctx\">\n <img src=\""
