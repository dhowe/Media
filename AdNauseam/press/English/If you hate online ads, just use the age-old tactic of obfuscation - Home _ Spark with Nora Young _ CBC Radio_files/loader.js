var _CBC_LOADER = {
	...
	modules: {
		...
		// Current social media module:
		'socialmedia': { type:'js', fullpath:'/i/js/cbc_social_wrapper.js', requires:['cbc_config'] },

		// Legacy social media module:
		...
		//video
		'cbc.video.embed.swfvideoplayer' : { type:'js', fullpath:'/video/js/SWFVideoPlayer.js', requires: ['lib_swfobject_2.2']},
		...
		'lib_jquery_1.10.2': { type:'js', fullpath:'/i/l/jquery/jquery-1.10.2.min.js' },
		...
		//'pluck': { type:'js', fullpath:'http://%%SITELIFE_DOMAIN%%/ver1.0/Direct/JavascriptSDKProxy' },
