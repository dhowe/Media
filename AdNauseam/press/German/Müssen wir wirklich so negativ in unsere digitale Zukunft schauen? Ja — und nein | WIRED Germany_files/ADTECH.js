...
document.write("<img src=\"https://s79.research.de.com/bb-mx/prime?pjid=126425&place=123053246&cpid=9083788&size=1x1&mod=1&dur=0&sek=30&swf=0&tm=30283408\" />\n");
document.write("<img src=\"https://s79.research.de.com/bb-mx/prime?pjid=126425&place=123053246&cpid=9083788&size=1x1&mod=13&dur=25&sek=30&swf=0&tm=30283408\" />\n");
document.write("<img src=\"https://s79.research.de.com/bb-mx/prime?pjid=126425&place=123053246&cpid=9083788&size=1x1&mod=13&dur=50&sek=30&swf=0&tm=30283408\" />\n");
document.write("<img src=\"https://s79.research.de.com/bb-mx/prime?pjid=126425&place=123053246&cpid=9083788&size=1x1&mod=13&dur=75&sek=30&swf=0&tm=30283408\" />\n");
document.write("<img src=\"https://s79.research.de.com/bb-mx/prime?pjid=126425&place=123053246&cpid=9083788&size=1x1&mod=2&dur=100&sek=30&swf=0&tm=30283408\" />\n");



document.write("<img src=\"https://aka-cdn.adtech.de/apps/339/Ad13288275St3Sz277Sq108822617V29Id1/clear.gif\" width=1 height=1 style=\"margin-top: -1\" id=\"5202193adTracking\">\n");
document.write("<scr"+"ipt>\n");
document.write("(function() {\n");
document.write("\"use strict\";\n");
document.write("var lastResult = 0;\n");
document.write("var parentContainer;\n");
document.write("var adID = '5202193adRollover';\n");
document.write("var trackingID = '5202193adTracking';\n");
...
document.write("window.open(\"https://secserv.adtech.de/adlink/1147/5202193/0/277/AdId=13288275;BnId=1;itime=30283408;nodecode=yes;link=\"+\"https://secserv.adtech.de/adlink/1147/5202193/0/277/AdId=13288275;BnId=1;itime=30283408;nodecode=yes;link=\"+adURL, '_blank');\n");
document.write("});\n");
document.write("i++;\n");
document.write("}\n");
document.write("}\n");
...
document.write("trackingImg.src = \"https://ad.doubleclick.net/ddm/trackimp/N34502.1979701WIRED.DE/B9083788.123053246;dc_trk_aid=296139106;dc_trk_cid=65702469;ord=30283408?\".replace('30283408', Date.now());\n");
document.write("}\n");
...
document.write("</scr"+"ipt>\n");
function cleanUp() {
 if (typeof __parent.swappedRefs5202193 == "undefined") {
   __parent.swappedRefs5202193 = new Array();
 }
   
 while (__parent.swappedRefs5202193.length > 0) {
   var ref = __parent.swappedRefs5202193.pop();
   if (ref != "swappedRefs5202193") {
     __parent[ref] = null;
   }
 }
}
...
if (typeof inFIF != "undefined" && inFIF == true) {
 ...
 for (var ref in window) {
   if ((typeof __parent[ref] == "undefined" || __parent[ref] == null) 
         && ref != "frameElement" && ref != "event" && ref != "swappedRefs5202193" && ref != "onunload") {
     try {__parent[ref] = window[ref]; __parent.swappedRefs5202193.push(ref);} catch (e) {}
  } 
 }  
}
