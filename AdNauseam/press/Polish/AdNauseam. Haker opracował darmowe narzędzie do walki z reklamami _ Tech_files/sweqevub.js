...
if (typeof gemius_hcconn == "undefined") {
	gemius_hcconn = {
		...
		hc : (typeof pp_gemius_hitcollector != 'undefined')?pp_gemius_hitcollector:(typeof gemius_hitcollector != 'undefined')?gemius_hitcollector:'gcontent.services.tvn.pl',
		...
		addframe : function(ssl,file,args,rcvfn) {
			if (document.body) {
				...
				var url = 'http'+(ssl?'s':'')+'://gcontent.services.tvn.pl/ls'+file+'.html'+args;
				if (rcvfn!=null) {
