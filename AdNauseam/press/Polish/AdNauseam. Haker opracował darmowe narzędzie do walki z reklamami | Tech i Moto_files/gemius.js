...
if (typeof gemius_hcconn == "undefined") {
	gemius_hcconn = {
		...
		hc : (typeof gemius_hitcollector != 'undefined')?gemius_hitcollector:(typeof pp_gemius_hitcollector != 'undefined')?pp_gemius_hitcollector:'tvn.hit.gemius.pl',
...
(function () {
	if (typeof gemius_identifier != 'undefined' && !gemius_identifier.match(/^USED_/)) {
		if (typeof gemius_extraparameters != 'undefined') {
			gemius_hcconn.gevent(0,91,[gemius_identifier].concat(gemius_extraparameters),2,1);
		} else {
			gemius_hcconn.ghit(0,91,[gemius_identifier],2,1);
		}
		...
		if (typeof pp_gemius_extraparameters != 'undefined') {
			gemius_hcconn.gevent(0,91,[pp_gemius_identifier].concat(pp_gemius_extraparameters),2,1);
		} else {
			gemius_hcconn.ghit(0,91,[pp_gemius_identifier],2,1);
		}
		if (gemius_hcconn.event_identifier==null) {
