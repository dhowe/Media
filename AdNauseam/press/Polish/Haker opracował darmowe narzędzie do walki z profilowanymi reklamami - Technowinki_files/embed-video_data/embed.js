...
var nextClipManager = {
    ...
    _init: function () {
        ...
        appEvents.on(appEvents.PLAYER_READY, function () { // player starting play material
            ...
            if (that.embed && currentClip.url !== 'http://') {
                notification.titleHref = currentClip.url;
                if (poloniaModule.isPoloniaVersion()) {
                    notification.logo = "http://ocdn.eu/images/pulscms/YTg7MDA_/4529777b2d3851d000069836928b51b9.png";
                } else {
                    notification.logo = "http://ocdn.eu/files/pulscms/MGY7MDA_/2b5c5d3aa482a7ca8c4b508fd4e78e98.png";
                }
                notification.logoHref = currentClip.url;
            }
...
var poloniaModule = function() {
    ...
    var tryChangeLogoToPoloniaVersion = function() {
        if (logoHtmlIsLodaed && poloniaGeoDetected) {
            var siteLogo = $('#portalLink img');
            if (typeof siteLogo !== 'undefined') {
                if (siteLogo.hasClass('o_channelLogo')) {
                    siteLogo.attr('src', 'http://ocdn.eu/images/pulscms/YjQ7MDA_/344a639b09708b832bbe8769d74a397a.png');
                } else {
                    siteLogo.attr('src', 'http://ocdn.eu/images/pulscms/NmQ7MDA_/bf9215a4849471dea8e6952677cedb25.png');
                }
            }
            $('#o_body, .o_wrapper_detail').addClass('polonia');
        }
